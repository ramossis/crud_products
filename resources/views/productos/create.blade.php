            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="strore_id" class="col-md-4 col-form-label text-md-end">{{ __('Almacen') }}</label>

                            <div class="col-md-6">
                                <input id="strore_id" type="text" class="form-control @error('strore_id') is-invalid @enderror" name="strore_id" value="{{ old('strore_id') }}" required autocomplete="strore_id">
